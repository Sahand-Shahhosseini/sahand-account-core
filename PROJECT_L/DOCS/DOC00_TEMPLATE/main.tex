...
(1) Latin text, (2) math glyphs, (3) Persian RTL text, (4) a table, (5) a chart, and
...
Persian (RTL, single line): \textfa{این یک تست نوشتار فارسی است.}

Persian (RTL, paragraph + numbers + punctuation):
\begin{fa}
این یک پاراگراف تست است تا جهت نوشتار راست‌به‌چپ درست اعمال شود.
عددها: ۱۲۳۴۵۶۷۸۹۰ — و ترکیب با نشانه‌ها: ( ) [ ] \{ \} ، ؛ !
\end{fa}
...
C & Persian+Math should render without tofu and with correct RTL. \\
\bottomrule
\end{tabularx}
\end{table}
